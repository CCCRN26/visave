...
export default async function NewMeeting({ params }) {
  ...
  return <>
    <h1>Start Meeting</h1>
    <p className="muted">Opening balances and the active-member attendance snapshot are created automatically.</p>
    <GroupNav id={id}/>
    <StartMeetingForm groupId={id} today={today} googleMeetConnected={googleStatus.connected}/>
  </>;
}
